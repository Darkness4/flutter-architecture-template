...
import 'package:flutter_architecture_template/core/box_manager/mock_box_manager.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  ...
  if (environment == 'prod') {
    g.registerLazySingleton<BoxManager>(() => BoxManagerImpl());
    g.registerLazySingleton<GithubLocalDataSource>(
        () => GithubLocalDataSourceImpl(
              boxManager: g<BoxManager>(),
            ));
